...
if [ `grabseqs sra -m -l -o $HOME/tmp_test/test_metadata/ SRP057027 | wc -l` -ne 369 ]; then
    exit 1
fi
...
grabseqs sra -t 2 -o $HOME/tmp_test/test_tiny_sra ERR2279063
...
## download a tiny sample
grabseqs mgrast -o $HOME/tmp_test/test_tiny_mg mgm4793571.3
