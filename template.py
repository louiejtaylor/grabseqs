...
def process_XYZ_args(args):
    """
    Controller function for parsing XYZ repository data/metadata downloading.
    """
    ...
    for XYZ_identifier in args.XYZid:
        sample_list, metadata_agg = get_XYZ_acc_metadata(XYZ_identifier, metadata_agg)
        for sample in sample_list:
            download_XYZ_sample(acc,
                                args.retries,
                                args.threads,
                                args.outdir,
                                args.force,
